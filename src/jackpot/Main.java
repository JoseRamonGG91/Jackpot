...
public class Main extends javax.swing.JFrame {
    ...
    private static final float CENT_50 = 0.5F, EURO_1 = 1.0F, EURO_2 = 2.0F;
    int[] tirada;
    tragaperras maquina1 = new tragaperras();
   ...
   /**
    ...
    private void jButtonPalancaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonPalancaActionPerformed
        maquina1.resSaldo(CENT_50);
        tirada = maquina1.generarTirada();
        for (int i = 0; i < tragaperras.COLUMNAS; i++) {
            String url = "/imagenes/"+ tirada[i] +".png";
            switch (i) {
                case 0:
                    jLabelImagen1.setIcon(new ImageIcon(getClass().getResource(url)));break;
                case 1:
                    jLabelImagen2.setIcon(new ImageIcon(getClass().getResource(url)));break;
                case 2:
                    jLabelImagen3.setIcon(new ImageIcon(getClass().getResource(url)));break;        
            }
        }
        jLabelPremio.setText(formato.format(premios.Comprobar(tirada)));
        maquina1.sumSaldo(premios.Comprobar(tirada));
        Actualizar();
        if(maquina1.getSaldo() == 0)
            BloquearMaquina();
    ...
    private void jButton50centActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton50centActionPerformed
        maquina1.sumSaldo(CENT_50);
        tragaperras.sumDeposito(CENT_50);
        Actualizar();
    ...
    private void jButton1euroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1euroActionPerformed
        maquina1.sumSaldo(EURO_1);
        tragaperras.sumDeposito(EURO_1);
        Actualizar();
    ...
    private void jButton2euroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2euroActionPerformed
        maquina1.sumSaldo(EURO_2);
        tragaperras.sumDeposito(EURO_2);
        Actualizar();
    ...
    private void jButtonCobrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonCobrarActionPerformed
        if (maquina1.getSaldo() > tragaperras.DEPOSITO)
            JOptionPane.showMessageDialog(this, "No hay suficientes monedas pase por caja para cobrar " + (maquina1.getSaldo() - tragaperras.DEPOSITO) + "€", "No hay dinero", JOptionPane.INFORMATION_MESSAGE);
        else {
            tragaperras.resDeposito(maquina1.getSaldo());
        }
        maquina1.resetSaldo();
        Actualizar();
        BloquearMaquina();
        jLabelPremio.setText(formato.format(0));
    }//GEN-LAST:event_jButtonCobrarActionPerformed

    private void BloquearMaquina() {
        jButtonCobrar.setEnabled(false);
        jButtonPalanca.setEnabled(false);
        jLabelImagen1.setIcon(new ImageIcon(getClass().getResource("/imagenes/vacio.png")));
        jLabelImagen2.setIcon(new ImageIcon(getClass().getResource("/imagenes/vacio.png")));
        jLabelImagen3.setIcon(new ImageIcon(getClass().getResource("/imagenes/vacio.png")));  
    }
    
    private void Actualizar() {
        System.out.println("Deposito de la maquina:\t" + tragaperras.DEPOSITO);
        jButtonCobrar.setEnabled(true);
        jButtonPalanca.setEnabled(true);
        jLabelSaldo.setText(maquina1.MostrarSaldo());
    }
    /**
